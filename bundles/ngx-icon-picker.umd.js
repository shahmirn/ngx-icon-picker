(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-icon-picker', ['exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-icon-picker'] = {}, global.ng.core, global.ng.common));
    ...
    ***************************************************************************** */
            ...
            ipIconPacks.forEach(function (ipIconPack) {
                if (ipIconPack === 'fa' || ipIconPack === 'all') {
                    var faIcons = _this.getFaIcons().map(function (icon) {
                        icon.type = exports.IconType.FONT_AWESEOME;
                        return icon;
                    });
                ...
                if (ipIconPack === 'bs' || ipIconPack === 'all') {
                    var bsIcons = _this.getBsIcons().map(function (icon) {
                        icon.type = exports.IconType.BOOTSTRAP;
                        return icon;
                    });
                ...
                if (ipIconPack === 'fa5' || ipIconPack === 'all') {
                    var fa5Icons = _this.getFa5Icons().map(function (icon) {
                        icon.type = exports.IconType.FONT_AWESEOME5;
                        return icon;
                    });
    ...
    var IconPickerComponent = /** @class */ (function () {
        function IconPickerComponent(el, cdr, service) {
            ...
            this.iconType = exports.IconType;
        ...
        IconPickerComponent.prototype.selectIcon = function (icon) {
            if (icon.type === exports.IconType.FONT_AWESEOME) {
                this.directiveInstance.iconSelected("fa fa-" + icon.id);
            }
            else if (icon.type === exports.IconType.BOOTSTRAP) {
                this.directiveInstance.iconSelected("glyphicon glyphicon-" + icon.id);
            }
            else if (icon.type === exports.IconType.FONT_AWESEOME5) {
    ...
    var IconPickerDirective = /** @class */ (function () {
        function IconPickerDirective(vcRef, el, cfr) {
            ...
            this.iconPickerSelect = new core.EventEmitter(true);
